...
//String queryStr = "select cds.id, cds.category, cds.name from CdDrugSearch cds where ";
    ...
    public Vector listSearchElement(
            String str) {
        //EntityManagerFactory emf = (EntityManagerFactory) SpringUtils.getBean("entityManagerFactory");
        //EntityManager em = emf.createEntityManager();
...
//String queryStr = "select cds.id, cds.category, cds.name from CdDrugSearch cds where ";
    ...
    public Vector listSearchElementRoute(
            String str, String route) {
        EntityManager em = JpaUtils.createEntityManager();
...
//String queryTwo = "select cds.id, cds.category, cds.name from CdDrugSearch cds where ";
    ...
    public Vector listBrandsFromElement(
            String drugID) {
        EntityManager em = JpaUtils.createEntityManager();
    ...
    public Vector listSearchElementSelectCategories(
            String str, Vector cat) {
        EntityManager em = JpaUtils.createEntityManager();
    ...
    public Vector getAllergyWarnings(
            String atcCode, Vector allergies) {
        List results = new ArrayList();
        Vector vec = new Vector();
        Hashtable ha = new Hashtable();
    ...
    public Vector getMadeGenericExample(String groupno, String formCode, boolean html){
        ...
        return getDrugByDrugCode(drugCode,html);
    }
    ...
    public Vector getDrugByDrugCode(String pKey, boolean html) {
        String productId = "";
        String origId = pKey;
        Vector returnRows = new Vector();
